      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 pt-32 pb-24 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
          ...
          <div className="lg:col-span-7">
            ...
            >
              India's trusted B2B sourcing partner for electronic components,
              industrial hardware, specialty cables, and IT equipment.
              Bulk pricing. Verified quality. Pan-India delivery.
            </motion.p>
            ...
            >
              <Link to="/quote">
                <BtnPrimary>Request a Quote</BtnPrimary>
              </Link>
              <Link to="/products">
                <BtnOutline>Browse Products</BtnOutline>
              </Link>
            </motion.div>
